> **Archived draft, not a public release.** This file contains claims that were never released or in use. Its “Public Release,” “Production Ready,” “proven,” and test-count statements are historical draft text, not current status. Do not use it as release evidence. Current status: in development, unreleased, and not in use.
...
- **Security**: See [Security issues](https://github.com/Sailor422/itdd-control-plane/security)
