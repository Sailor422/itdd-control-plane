# Historical controller examples (not current onboarding)

> Archived 2026-09-24. These are retained as development history only. They are not a supported workflow, current product capability guarantee, or authorization to execute. The repository is in development, unreleased, and not in use. See the current [Prime planning guide](../../agents/itdd-in-prime-usage.md).

The examples are preserved for research context. They may be stale and require review against current code before reuse. Local machine paths have been generalized in this archived copy.
...
root = Path("<local-user-home>/Projects/oak-harbor-marina")
...
Expected: `<installed-prime-agent-path>`
